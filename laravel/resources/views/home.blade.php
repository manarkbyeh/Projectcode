...
-->
    <div class="game_container">
      <a href="{{ url('/game') }}">
        <div class="img_div">
          <img src="{{ asset('images/game/bg.png') }}" alt="game background">
        </div>
        <div class="text_div">
          <h3>GAME</h3>
          <p>A-Nota's is het allernieuwste spel voor je mobieltje! Doorkruis de stad Antwerpen en ga op zoek naar je verloren lesnotities.</p>
        </div>
      </a>
    </div>
    <!-- **************************************
